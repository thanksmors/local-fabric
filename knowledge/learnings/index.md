...
Template: [../../.fabric/templates/learning-note.md](../../.fabric/templates/learning-note.md)

## Scope

Learning notes capture reusable insights discovered during implementation, debugging, research, review, or project operation.

## Learning Notes

| Date | Learning | Path | Applies To | Source |
|---|---|---|---|---|
...
| Log | Scope |
|---|---|
| [log.md](./log.md) | Learning index history. |

## Rules

- Record learnings only when they are likely to help future work.
- Prefer short, operational notes over diary entries.
- Link to supporting research, decisions, source files, issues, PRs, or incident notes.
- Capture the reusable lesson, not a diary of the whole task.
